...
class Checkout_Confirmation(BrowserUtils):
    ...
    def enter_delivery_address(self,countryName):
        ...
        wait.until(expected_conditions.presence_of_element_located(self.country_option)) #* not required as it is already accepting tuple
    ...
    def validate_order(self):
        s = self.driver.find_element(*self.success_message).text
        assert "Success! Thank you!" in s